const Header = () => {
  return (
    <header className='flex uppercase font-semibold text-lg justify-between px-12 py-6 fixed w-full z-50 bg-white'>
...
const NavItem = ({ title }: { title: string }) => {
  ...
  return (
    <li className='px-6 hover:text-yellow-300 cursor-pointer transition-colors inline-block' onClick={onSelect}>
      {title}
    </li>
  );
};
